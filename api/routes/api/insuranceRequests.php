...
Route::post('/insurance_requests', [InsuranceRequestController::class, 'store']);
Route::post('/insurance_requests/status', [InsuranceRequestController::class, 'updateStatus']);